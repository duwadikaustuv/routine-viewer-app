...
const TodayPage = () => {
  ...
  // Create a mapping between full day names and abbreviated day names
  const dayMapping = {
    Sunday: "Sun",
    Monday: "Mon",
    Tuesday: "Tue",
  ...
  // Filter routine data using the abbreviated day name
  const filteredRoutine = routineData.filter(
    (item) =>
      ...
      item.day === dayMapping[selectedDay]
  );
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <div className="inline-block bg-white p-2 rounded-lg shadow-sm mb-4">
            <span className="text-2xl">{getDayEmoji(selectedDay)}</span>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-indigo-100 p-6 mb-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="relative" ref={dayDropdownRef}>
              ...
              {showDayDropdown && (
                <div className="absolute mt-2 w-48 bg-white border border-indigo-100 rounded-lg shadow-lg z-10">
                  {[
                    "Sunday",
                    "Monday",
                    "Tuesday",
                    ...
                    <button
                      ...
                      className={`w-full px-4 py-3 text-left hover:bg-indigo-50 flex items-center transition-colors ${
                        day === selectedDay
                          ? "bg-indigo-50 text-indigo-700 font-medium"
                          : "text-gray-700"
                      }`}
                    >
                      <span className="mr-3">{getDayEmoji(day)}</span>
                      {day}
                    </button>
                  ))}
                </div>
            ...
            <div className="relative" ref={optionsRef}>
              ...
              {showOptions && (
                <div className="absolute mt-2 right-0 w-52 bg-white border border-indigo-100 rounded-lg shadow-lg p-3 z-10">
          ...
          {filteredRoutine.length > 0 ? (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-indigo-100 p-8 text-center">
              ...
              <p className="text-gray-600">
                Enjoy your free time or catch up on your studies!
              </p>
            </div>
          )}
        </div>
